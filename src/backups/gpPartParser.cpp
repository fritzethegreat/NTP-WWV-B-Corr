...
GpPartParser::GpPartParser()
    : FileParser( NULL, GpPartParser::length, GpPartParser::tags )
{
  LOG_DEBUG( 11, "()" )
...
GpPartParser::GpPartParser( string fileName )
  : FileParser( fileName, GpPartParser::length, GpPartParser::tags )
{
...
void GpPartParser::initDataSeries() {
  LOG_DEBUG( 8, "()" )
...
}// end void GpPartParser::GpPartParser initDataSeries()
