...
#ifndef CRSCORR_GPPART_FILEPARSER_H
#define CRSCORR_GPPART_FILEPARSER_H

#define GPPART_LINESIZE 180

class GpPartParser : public FileParser {
  ...
  public:
   ...
   static const FileParser::DataTag tags[];
     ...
     */
    GpPartParser();
    GpPartParser( string fileName );
    GpPartParser( const GpPartParser& copy );
    ~GpPartParser();
    GpPartParser& operator=(const GpPartParser& copy );
