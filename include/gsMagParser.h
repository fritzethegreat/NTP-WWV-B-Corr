...
#ifndef CRSCORR_GSMAG_FILEPARSER_H
#define CRSCORR_GSMAG_FILEPARSER_H

#define GSMAG_LINESIZE 180

class GsMagParser : public FileParser {
  ...
  public:
   ...
   static const FileParser::DataTag tags[];
     ...
     */
    GsMagParser();
    GsMagParser( string fileName );
    GsMagParser( const GsMagParser& copy );
    ~GsMagParser();
    GsMagParser& operator=(const GsMagParser& copy );
